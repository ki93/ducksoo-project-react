...
// Application imports
import Task from '../bryntumlib/Task';
import '../bryntumlib/StatusColumn';
import '../bryntumlib/GanttToolbar';

const BryntumGanttAdvanced = props => {
    ...
    const ganttConfig = {
        ...
        project: {
            ...
            transport      : {
                load: {
                    url : 'bryntumdata/advanced-launch-saas.json'
                }
            },
            autoLoad : true,
...
export default BryntumGanttAdvanced;
